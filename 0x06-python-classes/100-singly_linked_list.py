...
class Node:
    ...
    Attributes:
        ...
        __next_node: Private instance attribute representing the next node in the linked list.
...
class SinglyLinkedList:
    ...
    Methods:
        ...
        sorted_insert: Public instance method that inserts a new Node into the correct sorted position.
    """
